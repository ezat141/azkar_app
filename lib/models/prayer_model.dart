...
class Timings {
  ...
  // Custom [] operator to get the prayer time by name.
  operator [](String prayerName) {
    switch (prayerName) {
      case 'Fajr':
        return fajr;
      case 'Sunrise':
  ...
  // Custom entries getter to get the prayer times as a map.
  ...
  // Custom last getter to get the last prayer time.
  String get last => entries.last.key;
}
